...
public class ManipuladorGlobalExcecoes{
    ...
    public ResponseEntity<ErrorDTO> notFoundException(NotFoundException notFoundException){
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.NOT_FOUND.value(),HttpStatus.NOT_FOUND.name(),notFoundException.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorDTO);
    }
    @ExceptionHandler(DuplicateException.class)
    public ResponseEntity<ErrorDTO> duplicateException(DuplicateException duplicateException){
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.name(), duplicateException.getMessage());
    ...
    public ResponseEntity<ErrorDTO> databaseInsertException(DatabaseInsertException databaseInsertException){
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.UNPROCESSABLE_ENTITY.value(), HttpStatus.UNPROCESSABLE_ENTITY.name(), databaseInsertException.getMessage());
