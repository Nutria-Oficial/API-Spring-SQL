...
public interface UsuarioApi {
  @Operation(
      ...
      description = "Recebe um dto com as informações do usuário e adiciona no banco")
  @ApiResponses({
    @ApiResponse(
        responseCode = "201",
        description = "Usuário cadastrado no banco com sucesso",
        content =
            @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = ResponseUsuarioDTO.class))),
    @ApiResponse(
        responseCode = "400",
    ...
    @ApiResponse(
        responseCode = "409",
        description = "Conflito ao tentar inserir no banco",
        content =
            @Content(
                mediaType = "application/json",
    ...
    @ApiResponse(
        responseCode = "422",
        description = "Erro ao tentar inserir as informações no banco",
        content =
            @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = ErrorDTO.class)))
  ...
  @Operation(
      ...
      description = "Recebe um email para buscar um usuário com base nele")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description = "Recebe um nome para atualizar o nome do usuário")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description = "Recebe um email para atualizar o email do usuário")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Usuário atualizado com sucesso",
  ...
  @Operation(
      summary = "Atualiza o telefone do usuário",
      description = "Recebe um telefone para atualizar o telefone do usuário")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Usuário atualizado com sucesso",
  ...
  @Operation(
      ...
      description = "Recebe a senha antiga e a senha nova para atualizar a senha do usuário")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Usuário atualizado com sucesso",
  ...
  @Operation(
      summary = "Atualiza a empresa do usuário",
      description = "Recebe o nome da empresa para atualizar o nome da empresa do usuário")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Usuário atualizado com sucesso",
  ...
  @Operation(
      ...
      description = "Recebe a url da foto para atualizar a foto do usuário no banco")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Usuário atualizado com sucesso",
