...
public class UsuarioController implements UsuarioApi {
  ...
  public ResponseEntity<ResponseUsuarioDTO> cadastrarUsuario(
      @Valid @RequestBody RequestUsuarioDTO requestUsuarioDTO) {
  ...
  public ResponseEntity<ResponseUsuarioDTO> atualizarNomeUsuario(
      @PathVariable Integer id, @Valid @RequestBody NomeDTO nomeDTO) {
  ...
  public ResponseEntity<ResponseUsuarioDTO> atualizarEmailUsuario(
      @PathVariable Integer id, @Valid @RequestBody EmailDTO emailDTO) {
  ...
  public ResponseEntity<ResponseUsuarioDTO> atualizarTelefoneUsuario(
      @PathVariable Integer id, @Valid @RequestBody TelefoneDTO telefoneDTO) {
    ResponseUsuarioDTO responseUsuarioDTO =
        usuarioService.atualizarTelefoneUsuario(id, telefoneDTO);
    return new ResponseEntity<>(responseUsuarioDTO, HttpStatus.OK);
  }

  @Override
  @PatchMapping("/{id}/senha")
  public ResponseEntity<ResponseUsuarioDTO> atualizarSenhaUsuario(
      @PathVariable Integer id, @Valid @RequestBody SenhaDTO senhaDTO) {
  ...
  public ResponseEntity<ResponseUsuarioDTO> atualizarEmpresaUsuario(
      @PathVariable Integer id, @Valid @RequestBody EmpresaDTO empresaDTO) {
  ...
  public ResponseEntity<ResponseUsuarioDTO> atualizarFotoUsuario(
      @PathVariable Integer id, @Valid @RequestBody FotoDTO fotoDTO) {
